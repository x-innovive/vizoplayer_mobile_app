  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const RichTitleValue(title: 'MPAA Rating', value: 'PG-13'),
        const SizedBox(height: AppValues.paddingSmall),
        const RichTitleValue(title: 'Genre', value: 'Movies'),
        const SizedBox(height: AppValues.paddingSmall),
        const RichTitleValue(title: 'Actor', value: 'Úrsula Corberó, Itziar Ituño, Álvaro Morte, Alba Flores, Pedro Alonso'),
        const SizedBox(height: AppValues.paddingSmall),
        const RichTitleValue(title: 'Director', value: 'Álex Pina'),
        const SizedBox(height: AppValues.paddingSmall),
        const RichTitleValue(title: 'Country', value: 'French'),
        const SizedBox(height: AppValues.paddingSmall),
      ],
    );
  }
